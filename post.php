...
if (($_POST['Title'] && $_POST['Content'] && $_POST['Tag'] && $_FILES['upload'])) {
    ...
    $post = new Post($_POST['Title'], $_POST['Content'], $tag, $_FILES["upload"]["name"]);
    $postRepo->writePostToDb($_SESSION["email"], $post);
